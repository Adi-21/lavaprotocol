...
export interface LavaOptimizedVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "SATSUMA_LP_VAULT"
      | "TOTAL_BPS"
  ...
  encodeFunctionData(
    functionFragment: "SATSUMA_LP_VAULT",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(functionFragment: "Z_TOKEN", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "Z_TOKEN", data: BytesLike): Result;
...
export namespace AllocationSetEvent {
  export type InputTuple = [strategyId: BigNumberish, bps: BigNumberish];
  export type OutputTuple = [strategyId: bigint, bps: bigint];
...
export namespace RebalancedEvent {
  export type InputTuple = [
    zentraDelta: BigNumberish,
    satsumaDelta: BigNumberish
  ];
  export type OutputTuple = [zentraDelta: bigint, satsumaDelta: bigint];
  export interface OutputObject {
    zentraDelta: bigint;
    satsumaDelta: bigint;
  }
...
export interface LavaOptimizedVault extends BaseContract {
  connect(runner?: ContractRunner | null): LavaOptimizedVault;
  waitForDeployment(): Promise<this>;

  interface: LavaOptimizedVaultInterface;
  ...
  SATSUMA_LP_VAULT: TypedContractMethod<[], [string], "view">;

  TOTAL_BPS: TypedContractMethod<[], [bigint], "view">;

  ZENTRA_POOL: TypedContractMethod<[], [string], "view">;

  Z_TOKEN: TypedContractMethod<[], [string], "view">;
  ...
  setAllocation: TypedContractMethod<
    [_strategyId: BigNumberish, _bps: BigNumberish],
    [void],
    "nonpayable"
  >;

  strategies: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "SATSUMA_LP_VAULT"
  ...
  filters: {
    "AllocationSet(uint256,uint256)": TypedContractEvent<
      AllocationSetEvent.InputTuple,
      AllocationSetEvent.OutputTuple,
      AllocationSetEvent.OutputObject
    >;
    ...
    "Rebalanced(int256,int256)": TypedContractEvent<
      RebalancedEvent.InputTuple,
      RebalancedEvent.OutputTuple,
      RebalancedEvent.OutputObject
    >;
