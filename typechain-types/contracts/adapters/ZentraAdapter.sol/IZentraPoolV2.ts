...
export interface IZentraPoolV2Interface extends Interface {
...
export interface IZentraPoolV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IZentraPoolV2;
  waitForDeployment(): Promise<this>;

  interface: IZentraPoolV2Interface;
